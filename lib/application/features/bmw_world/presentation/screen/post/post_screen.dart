...
import 'package:bmw_world/application/features/bmw_world/presentation/screen/car/car_details_screen.dart';
        ...
        child: BlocBuilder<PostBloc, PostState>(
          builder: (context, state) {
            if (state is PostsLoading) {
              ...
              // TODO
              return const Center(child: Text('Posts not available'));
            }
          },
        ),
      ),
